...
int HANGMAN(){
    ...
    printf("\n==================================== HANGMAN ====================================\n");
    printf("Hangman merupakan permainan menebak kata dengan menebak satu-satu huruf yang ada pada kata.\n");
    printf("Pemain memiliki 10 kesempatan dalam bermain. Jika pemain berhasil menebak kata, maka pemain\n");
    printf("akan mendapatkan poin sesuai panjang kata yang berhasil ditebak, dan permainan akan berlanjut\n");
    printf("sampai kesempatan habis.\n");
    while (!valid){
        printf("Pilihan menu:\n");
